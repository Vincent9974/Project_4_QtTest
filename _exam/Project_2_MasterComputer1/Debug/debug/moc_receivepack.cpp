...
void ReceivePack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ReceivePack *_t = static_cast<ReceivePack *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ReceivePack::*_t)(char , char , int );
...
const QMetaObject ReceivePack::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ReceivePack.data,
      qt_meta_data_ReceivePack,  qt_static_metacall, nullptr, nullptr}
};
